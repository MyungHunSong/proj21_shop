...
<!-- Controller 경로 : proj21_shop.controller.order/MyOrderRestController 경로   -->
	$(function() {
...
<body>
	...
	<div class='wrap'>
			<ul>
				...
				<li>자세한 내용은 <a href="${contextPath}/listPaging?page=1&perPageNum=10&searchType=a&keyword=">FAQ</a>를 확인하여 주시기 바랍니다.</li>
			</ul>
		</div>
	<table class="type11">
		<thead>
