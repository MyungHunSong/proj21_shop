...
<body>
	<div class="FAQ"></div>
			<article>
				...
				<section class="title slide">상품 구매후 주소 변경을 하려면 어떻게 해야
					하나요?</section>
				<p class="desc slide">물품이 도착하지 않으셨다면 하단에 보이시는 전화
					번호로(02-444-4444)로 전화주시면 바뀐 주소로 수정해 드리겟습니다.</p>

				<section class="title">휴일에 상품을 받을수 있나요?</section>
				<p class="desc">택배사의 경우 휴일은 근무하지 않기 때문에 휴일에는 배송되지 않습니다. 단, 토요일은
					일부 택배 사에 한해 배송되는 점 참고해주십시오.</p>

				<h3 class="faqh3">교환/반품/환불</h3>
				<section class="title">환불을 신청했는데 환불 기간은 얼마나 소요되나요?</section>
				<p class="desc">취소완료가 되면 카드는 바로 결제취소가 이뤄지며, 카드사 홈페이지에서는 일반적으로
					2~5일 이 후 반영됩니다. 실시간 계좌이체의 경우는 환불계좌가 확인되는 때로부터 평일 기준 3~7일 이내 환불됩니다.
				</p>

				<section class="title">구매한 상품을 취소/교환/반품하려면 어떻게 해야 하나요?</section>
				<p class="desc">구매 후 또는 결제 완료 이후 구매의사가 변한 경우에는 취소가 가능합니다. 다만
					상품준비중 단계는 이미 배송 예약까지 완료된 상태로 이 경우는 반품절차에 의해서만 가능하오니 이 점 참고해주십시오.</p>

				<h3 class="faqh3">구매(결제)</h3>
				<section class="title">고객센터에서 전화상으로 본인 확인 후 대리 결제가 가능한가요?</section>
				<p class="desc">네 가능합니다.</p>
				<section class="title">무통장입금 주문 후, 입금하였는데 취소 문자를 받았습니다.</section>
				<p class="desc">담당센터(02-444-4444)로 문의 해주시기 바랍니다.</p>
				<section class="title">실시간 계좌이체 이용 가능 시간은 어떻게 되나요?</section>
				<p class="desc">은행의 업무상 저희 쇼핑몰은 국민:00:30 ~ 23:30으로 이 시간대 까지는
					가능합니다.</p>
