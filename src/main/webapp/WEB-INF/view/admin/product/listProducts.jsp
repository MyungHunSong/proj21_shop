...
<c:set var="selectedProducts"  value="${productsMap.selectedProducts}"  /> --%>
	...
	$(document).ready(function(){
		...
		function addNewModel(pro_code,pro_category){
			...
			window.open('${contextPath}/admin/product/addNewModelForm?pro_code='+pro_code+'&pro_category='+pro_category, '모델 추가하기',
...
<body>
	...
	<ul class="smallul">
	<li>전체&nbsp;<a href="${contextPath }/admin/product/listProducts?total=total">${totProducts }</a>건&nbsp;&nbsp;| </li>
	<li>신제품&nbsp;<a href="${contextPath }/admin/product/listProducts?direct_pro_status=newseller">${newProducts }</a>건&nbsp;&nbsp;| </li>
	<li>베스트셀러&nbsp;<a href="${contextPath }/admin/product/listProducts?direct_pro_status=bestseller">${bestProducts }</a>건&nbsp;&nbsp;| </li>
	<li>스테디셀러&nbsp;<a href="${contextPath }/admin/product/listProducts?direct_pro_status=steadyseller">${steadyProducts }</a>건&nbsp;&nbsp;| </li>
	<li>할인중&nbsp;<a href="${contextPath }/admin/product/listProducts?direct_pro_status=onSale">${offProducts }</a>건&nbsp;&nbsp;| </li>
	<li>품절&nbsp;<a href="${contextPath }/admin/product/listProducts?direct_pro_status=buy_out">${outProducts }</a>건 </li>
	</ul>
	</div>
	<br><br><br>
	...
	<c:choose>
		...
		<c:forEach var="product" items="${productsList}" >
			<tr style="text-align: center;">
				...
				<td><a href="${contextPath }/product/productdetail?pro_code=${product.pro_code}">${product.pro_code }</a></td>
				<td><a href="${contextPath }/product/productdetail?pro_code=${product.pro_code}">${product.pro_category }</a></td>
				<td><a href="${contextPath }/product/productdetail?pro_code=${product.pro_code}">${product.pro_status }</a></td>
				<td style="border-right-color: #ffffff;"><a href="${contextPath }/product/productdetail?pro_code=${product.pro_code}">
				<img width="180px;" height="270px;" src="${contextPath}/thumbnails?pro_code=${product.pro_code}&fileName=${product.pro_imageFileName}
				"><br>
				${product.pro_name }</a></td>
				<td><a href="${contextPath }/product/viewDetailProduct?pro_code=${product.pro_code}">
				<fmt:formatNumber value="${product.pro_price }" type="number" var="pro_price"/>
				${pro_price }원</a></td>
				<td><a href="${contextPath }/product/productdetail?pro_code=${product.pro_code}">${product.pro_salesrate }</a></td>
				<td><a href="${contextPath }/product/productdetail?pro_code=${product.pro_code}">${product.pro_count }</a></td>
			...
			<c:forEach var="page" begin="1" end="${selectedProducts/20+1 }" step="1">
				<c:choose>
					<c:when test="${page==pageNum }">
						<a class="sel-page" href="${contextPath }/admin/product/listProducts?
						section=${section}
						&pageNum=${page}
						&pro_name=${keyword}
