...
VALUES
	...
	(1112, 1, 'blackT',    5000, '검정색 반팔티 S사이즈 입니다.'  , 10 , 11, 2, 10),
	(1114, 1, 'blackT',    5000, '검정색 반팔티 L사이즈 입니다.'  , 10 , 11, 4, 10),
	(1115, 1, 'blackT',    5000, '검정색 반팔티 XL사이즈 입니다.'  , 10 , 11, 5, 10),
	(1113, 1, 'blackT',    5000, '검정색 반팔티 M사이즈 입니다.'  , 10 , 11, 3, 10),
	(1031, 1, 'grayT',     5000, '회색 반팔티 XS사이즈 입니다.'    , 10 , 3, 1, 10),
	(1032, 1, 'grayT',     5000, '회색 반팔티 S사이즈 입니다.'    , 10 , 3, 2, 10),
	(1034, 1, 'grayT',     5000, '회색 반팔티 L사이즈 입니다.'    , 10 , 3, 4, 10),
	(1035, 1, 'grayT',     5000, '회색 반팔티 XL사이즈 입니다.'    , 10 , 3, 5, 10),
...
('test02', 5083, '이종윤', 1, 5000, 0, '이종윤', '010-1234-5678', '010-1234-5678', 54545,'대구광역시 남구 봉덕동 이천로 51', '2층', '배송참고사항', '이종윤', '국민'),
('test02', 5013, '이종윤', 1, 5000, 0, '이종윤', '010-1234-5678', '010-1234-5678', 54545,'대구광역시 남구 봉덕동 이천로 51', '2층', '배송참고사항', '이종윤', '국민'),
('test03', 6163, '이종윤', 1, 5000, 0, '이종윤', '010-1234-5678', '010-1234-5678', 54545,'대구광역시 남구 봉덕동 이천로 51', '2층', '배송참고사항', '이종윤', '국민'),
('test03', 6163, '이종윤', 1, 5000, 0, '이종윤', '010-1234-5678', '010-1234-5678', 54545,'대구광역시 남구 봉덕동 이천로 51', '2층', '배송참고사항', '이종윤', '국민'),
('test03', 4073, '이종윤', 1, 5000, 0, '이종윤', '010-1234-5678', '010-1234-5678', 54545,'대구광역시 남구 봉덕동 이천로 51', '2층', '배송참고사항', '이종윤', '국민'),
('test04', 4093, '이종윤', 1, 5000, 0, '이종윤', '010-1234-5678', '010-1234-5678', 54545,'대구광역시 남구 봉덕동 이천로 51', '2층', '배송참고사항', '이종윤', '국민'),
('test04', 4033, '이종윤', 1, 5000, 0, '이종윤', '010-1234-5678', '010-1234-5678', 54545,'대구광역시 남구 봉덕동 이천로 51', '2층', '배송참고사항', '이종윤', '국민'),
('test05', 4113, '이종윤', 1, 5000, 0, '이종윤', '010-1234-5678', '010-1234-5678', 54545,'대구광역시 남구 봉덕동 이천로 51', '2층', '배송참고사항', '이종윤', '국민'),
('test05', 5033, '이종윤', 1, 5000, 0, '이종윤', '010-1234-5678', '010-1234-5678', 54545,'대구광역시 남구 봉덕동 이천로 51', '2층', '배송참고사항', '이종윤', '국민'),
('test05', 5023, '이종윤', 1, 5000, 0, '이종윤', '010-1234-5678', '010-1234-5678', 54545,'대구광역시 남구 봉덕동 이천로 51', '2층', '배송참고사항', '이종윤', '국민');
