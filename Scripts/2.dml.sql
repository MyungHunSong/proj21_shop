...
values 
('test02', 123, '이종가', '010-1234-5678', '1994-08-17', 1, 746858, '대구광역시 봉덕동 이천로 51', '3층', '본인확인질문', '본인확인질문답변', 'test1@test.co.kr'),
('test03', 123, '이종나', '010-1234-5678', '1994-08-17', 1, 746851, '대구광역시 봉덕동 이천로 52', '2층','본인확인질문', '본인확인질문답변', 'test2@test.co.kr'),
('test04', 123, '이종다', '010-1234-5678', '1994-08-17', 1, 746852, '대구광역시 봉덕동 이천로 53', '1층','본인확인질문', '본인확인질문답변', 'test3@test.co.kr'),
('test05', 123, '이종라', '010-1234-5678', '1994-08-17', 0, 746853, '대구광역시 봉덕동 이천로 54', '2층','본인확인질문', '본인확인질문답변', 'test4@test.co.kr'),
('test06', 123, '이종마', '010-1234-5678', '1994-08-17', 0, 746854, '대구광역시 봉덕동 이천로 55', '3층','본인확인질문', '본인확인질문답변', 'test5@test.co.kr');
